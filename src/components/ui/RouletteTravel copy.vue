<template>
  <div class="flex flex-col items-center">
    <div
      class="roulette w-80 h-80 border-4 border-gray-500 rounded-full relative"
      :style="rouletteStyle"
      v-if="items.length"
    >
    ...
    <div class="roulette w-80 h-80 border-4 border-gray-500 rounded-full relative bg-red-300" v-else></div>
